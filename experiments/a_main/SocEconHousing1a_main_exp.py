...
## Main Experiment
parameters = dict({
    'r_correlation': ap.Values(0, 0.25, 0.5, 0.75, 1),
    'a_preferences': ap.Values(0, 0.25, 0.5, 0.75, 1),
    'd_decay': ap.Values(0.95, 0.9, 0.85, 0.8),
    'size': 30,
    'density': 0.85,
    'vision': 1,
    'distribution': 2,
...
for i in range(iterations):
    ...
    del experiment, results, parameters_df_temp, unit_raw_temp
    gc.collect()

## Data Export
parameters_df.to_parquet('./data/main/parameters.parquet')
unit_raw.to_parquet('./data/main/unit_raw.parquet')