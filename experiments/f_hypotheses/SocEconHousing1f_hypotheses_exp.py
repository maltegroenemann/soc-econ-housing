...
parameters = dict({
    'r_correlation': ap.Values(0.4, 0.5, 0.6), # the correlation parameter is lower than the resulting Pearson coefficient
    'a_preferences': ap.Values(0.2, 0.3, 0.4),
    'd_decay': ap.Values(0.95, 0.925, 0.9),
    'size': 30,
    'density': 0.85,
    'vision': 1,
    'distribution': 2,
...
## Data Export
parameters_df.to_parquet('./data/hypotheses/parameters.parquet')
unit_raw.to_parquet('./data/hypotheses/unit_raw.parquet')